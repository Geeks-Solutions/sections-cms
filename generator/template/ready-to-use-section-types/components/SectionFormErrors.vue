<template>
  <div>
    <span v-if="showSectionError && selectedLang !== defaultLang" id="required-fields" class="flexSections sections-required-field-error">{{ $t('checkRequiredField', {lang: defaultLang}) }}</span>
  </div>
</template>
