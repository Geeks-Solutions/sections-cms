    ...
    buttonStyle() {
      switch (this.type) {
        case 'primary':
          return {
            wrapper:
              'shadow-sm border bg-Primary_Color_600 border-Primary_Color_600 hover:bg-Primary_Color_400 hover:border-Primary_Color_400 buttonPrimaryFocused',
            text: 'text-white',
            disabledWrapper:
              'border bg-Primary_Color_10 border-Primary_Color_10',
            disabledText: 'text-white',
          }
        case 'outlined':
          return {
            wrapper:
              'shadow-sm border border-Gray_300 hover:bg-Gray_50 hover:border-Gray_300 buttonOutlinedFocused',
        ...
        case 'secondary':
          return {
            wrapper:
              'shadow-sm border bg-Primary_Color_50 border-Primary_Color_50 hover:bg-Gray_1000 hover:border-Gray_1000 buttonSecondaryFocused',
            text: 'text-Primary_700 hover:text-Primary_Color_800',
            disabledWrapper:
              'border bg-Primary_Color_25 border-Primary_Color_25',
        ...
        case 'destructive':
          return {
            wrapper:
              'shadow-sm border bg-Error_600 border-Error_600 hover:bg-Error_700 hover:border-Error_700 buttonDestructiveFocused',
            text: 'text-white',
