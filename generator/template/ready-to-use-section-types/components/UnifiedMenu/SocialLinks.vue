<template>
  <div class="social-media-links mb-6 flex justify-center gap-3">
    ...
    <a v-if="showWhatsApp && whatsappNumber" :href="whatsappUrl" target="_blank" rel="noopener"
...
const whatsappUrl = computed(() => {
  ...
  if (props.enableBranches) {
    message = props.whatsappMessage || (props.type === 'service'
      ? props.i18n('whatsapp.defaultServiceMessage') || 'Hello! I would like to book a service.'
      : props.i18n('whatsapp.defaultOrderMessage') || 'Hello! I would like to place an order.')
  } else {
