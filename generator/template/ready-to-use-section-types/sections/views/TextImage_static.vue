<template>
  <div v-if="settings" class="text-image">
	...
	<div class="flex w-full px-5 md:px-20 py-14 md:py-20 justify-between items-center gap-8 row-wrapper" :class="[settings[0].imagePosition === 'right' ? 'flex-col md:flex-row image-right' : 'flex-col-reverse md:flex-row-reverse image-left', settings[0].sectionWrapperClass]">
