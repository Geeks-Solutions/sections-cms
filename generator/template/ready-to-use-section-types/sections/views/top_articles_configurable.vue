<template>
  <BlogsArticles :section-render-data="sectionRenderData" :section-render-settings="sectionRenderSettings" :lang="lang" :default-lang="defaultLang" list-type="listing" />
</template>
