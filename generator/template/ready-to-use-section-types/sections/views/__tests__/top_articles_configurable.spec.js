...
import TopArticlesConfigurable from '../top_articles_configurable.vue'
...
describe('TopArticlesConfigurable', () => {
  let wrapper

  const createWrapper = (propsData = {}) => {
    return shallowMount(TopArticlesConfigurable, {
      global: {
        components: {
  ...
  describe('Component Rendering', () => {
    ...
    it('should pass list-type="listing" to BlogsArticles', () => {
      wrapper = createWrapper()
      const blogsArticles = wrapper.findComponent(mockBlogsArticles)
      expect(blogsArticles.props('listType')).toBe('listing')
    })
  })
  ...
  describe('sectionRenderData Computed Property', () => {
    it('should return data object when section.render_data[0].data exists', () => {
      ...
      expect(data.articles[0].title).toBe('Top Article 1')
    })
  ...
  describe('Mounted Hook', () => {
    it('should call languageSupport on mount with section name', () => {
      ...
      wrapper = createWrapper()
      expect(languageSupport).toHaveBeenCalledWith('top_articles')
    })
