<template>
  <BlogsArticles
    ...
    :title="
      sectionRenderSettings && sectionRenderSettings.title
        ? sectionRenderSettings.title
        : ''
    "
    :description="
      sectionRenderSettings && sectionRenderSettings.description
...
<script>
export default {
  name: 'SelectiveArticlesConfigurable',
  props: {
    section: {
      type: Object,
      default: () => {},
