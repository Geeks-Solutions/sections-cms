      ...
      >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div>
            ...
            <input
              id="price-font-size"
              v-model="formData['--section-discounted-price-font-size']"
              @input="emitUpdate"
              type="text"
              placeholder="16px"
              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-4">
            ...
            />
            <ColorPicker
              v-model="formData['--section-discounted-price-color']"
              @update:model-value="emitUpdate"
              :label="`${$t('builderSettings.discountedPriceColor')}`"
              field-name="discounted-price-color"
            />
          </div>
          <!-- Hover State -->
          <div class="space-y-4">
            ...
            />
            <ColorPicker
              v-model="formData['--section-hover-discounted-price-color']"
              @update:model-value="emitUpdate"
              :label="`${$t('builderSettings.hoverDiscountedPriceColor')}`"
              field-name="hover-discounted-price-color"
            />
          </div>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-4">
            ...
            <ColorPicker
              ...
              @update:model-value="emitUpdate"
              :label="`${$t('builderSettings.limitedAvailabilityColor')}`"
              field-name="limited-availability-color"
            />
          </div>
          <!-- Hover State -->
          <div class="space-y-4">
            ...
            <ColorPicker
              ...
              @update:model-value="emitUpdate"
              :label="`${$t('builderSettings.hoverLimitedAvailabilityColor')}`"
              field-name="hover-limited-availability-color"
            />
          </div>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-4">
            ...
            <ColorPicker
              ...
              @update:model-value="emitUpdate"
              :label="`${$t('builderSettings.offColor')}`"
              field-name="off-color"
            />
          </div>
          <!-- Hover State -->
          <div class="space-y-4">
            ...
            <ColorPicker
              ...
              @update:model-value="emitUpdate"
              :label="`${$t('builderSettings.hoverOffColor')}`"
              field-name="hover-off-color"
            />
          </div>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-4">
            ...
            <ColorPicker
              ...
              @update:model-value="emitUpdate"
              :label="`${$t('builderSettings.durationColor')}`"
          ...
          <div class="space-y-4">
            ...
            <ColorPicker
              ...
              @update:model-value="emitUpdate"
              :label="`${$t('builderSettings.hoverDurationColor')}`"
              field-name="hover-duration-color"
            />
          </div>
        </div>
      </div>
...
let formData = reactive({
  ...
  '--section-discounted-price-font-size': '',
  '--section-discounted-price-color': '',
  '--section-hover-discounted-price-color': '',

  '--section-limited-availability-color': '',
  '--section-hover-limited-availability-color': '',

  '--section-off-color': '',
  '--section-hover-off-color': '',

  '--section-duration-color': '',
  '--section-hover-duration-color': '',
