  ...
  <div id="BooleanPrimaryContent" class="w-full">
    <div class="flex flex-row items-center cursor-pointer">
      ...
      <input
        ...
        type="checkbox"
        class="h-[15px] w-[15px] border border-FieldGray rounded-sm focus:outline-none"
        @change="toggleSwitch"
      />
    </div>
  </div>
...
export default {
      ...
      handler(value) {
        ...
        if (
          ...
          this.primary_content =
            this.configurableReference.optionsData.primary_content
        } else {
  ...
  methods: {
    toggleSwitch() {
      ...
      this.configurableReference.optionsData.primary_content =
        this.primary_content
      this.configurableReference.options[0].primary_content =
        this.primary_content
    },
