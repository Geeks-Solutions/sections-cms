...
export default {
    ...
    reference: {
      handler(value) {
        ...
        if (this.configurableReference.optionsData.default_limit) {
          this.default_limit = Number(
            this.configurableReference.optionsData.default_limit,
          )
        }
      },
      deep: true,
  ...
  methods: {
    changeFieldValue() {
      this.configurableReference.optionsData.default_limit = Number(
        this.default_limit,
      )
      this.configurableReference.options[0].default_limit = Number(
        this.default_limit,
      )
    },
  },
