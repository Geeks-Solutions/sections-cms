  ...
  it('validates WYSIWYG media presence in QAs', () => {
    ...
    wrapper.vm.settings[0].QAs.push({
      en: {
        ...
        answer: `<img src='${media.url}' media-id='${media.media_id}' />`,
      },
  ...
  it('removes unused media objects', () => {
    ...
    wrapper.vm.settings[0].QAs.push({
      en: {
        ...
        answer: `<img src='${media1.url}' data-media-id='${media1.media_id}' />`,
      },
      fr: { question: '', answer: '' },
    })
  ...
  it('keeps media if found in any QA answer', () => {
    ...
    wrapper.vm.settings[0].QAs.push({
      en: {
        ...
        answer: `<img src='${media.url}' data-media-id='${media.media_id}' />`,
      },
      fr: { question: '', answer: '' },
    })
