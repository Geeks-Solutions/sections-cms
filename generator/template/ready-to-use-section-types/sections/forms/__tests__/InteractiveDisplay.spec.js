...
describe('InteractiveDisplay', () => {
  ...
  test('updates videoLink when input changes', async () => {
    ...
    expect(wrapper.vm.settings[0].videoLink).toBe('https://example.com/video.mp4');
  });
  ...
  it('returns modified videoLink when mobileVideoLink is not set and videoLink is a YouTube link', async () => {
    ...
    setTimeout(() => {
      ...
      expect(wrapper.vm.computedMobileVideoUrl).toContain('https://www.youtube.com/watch?v=12345');
  ...
  it('returns modified mobileVideoLink when mobileVideoLink is set and is a YouTube link', () => {
    ...
    setTimeout(() => {
      ...
      expect(wrapper.vm.computedMobileVideoUrl).toContain('https://www.youtube.com/watch?v=67890');
  ...
  it('returns mobileVideoLink when it is set but not a YouTube link', () => {
    ...
    setTimeout(() => {
      ...
      expect(wrapper.vm.computedMobileVideoUrl).toBe('https://example.com/video.mp4');
    }, 1000)
