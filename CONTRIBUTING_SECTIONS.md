  ...
  - Example:
    ...
    <UploadMedia
      ...
      @uploadContainerClicked="
        selectedMediaIndex = 'featuredImage'
        $emit(
          'openMediaModal',
          settings[0].featuredImage ? settings[0].featuredImage.media_id : null
        )
      "
...
- **Responsive Design with Container Queries:**
  ...
  .my-section-container-wrapper {
    /* This element wraps your section's content */
